 ...
 **/
extern void ps2HandlerInit(port_t ps2_clock, struct ps2state *state) ;
 ...
 * \param state     the variable that holds the PS2 state.
 */
void ps2Interpret(struct ps2state *state, unsigned *action, unsigned *key, unsigned *modifier) ;
